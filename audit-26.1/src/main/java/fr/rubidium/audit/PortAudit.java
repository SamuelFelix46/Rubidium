...
public final class PortAudit implements ModInitializer {
    ...
    public void onInitialize() {
        ServerTickEvents.END_SERVER_TICK.register(server -> {
            ...
            try { Files.writeString(Path.of("port-audit.json"),"{\"minecraft\":\"26.1\",\"exactMathCases\":"+cases+",\"passed\":true,\"renderingModified\":false}"); }
            catch(Exception e) { throw new RuntimeException(e); }
            System.out.println("RUBIDIUM_PORT_AUDIT_OK 26.1 cases="+cases);
            server.halt(false);
        });
    }
